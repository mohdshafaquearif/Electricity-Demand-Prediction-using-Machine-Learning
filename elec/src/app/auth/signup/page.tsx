    ...
    try {
      const response = await fetch('/api/auth/signup', {
        ...
        body: JSON.stringify({
          ...
          password,
          role,
          areaName: role === 'AREA_MANAGER' ? areaName : undefined,
        }),
      })
        ...
        <div className="relative">
          ...
          <span className="absolute right-4 top-4">
            ...
            >
              <g opacity="0.5">
                <path
                  d="M19.6266 6.80626C18.7693 6.80626 17.9902 7.21543 17.4617 7.74373L11.5592 13.6462C11.3648 13.8378 11.1473 14.0074 10.9358 14.1608L6.42656 17.7468C5.96766 18.0521 5.26706 17.8713 5.26706 17.2906V12.1248C5.26706 11.3448 6.24466 10.8459 6.65934 11.1843L11.7016 15.0579C12.0902 15.3547 12.6177 15.4792 13.1242 15.3561L19.1423 14.7183C19.4202 14.6699 19.6458 14.4224 19.6458 14.1556V7.13263C19.6458 6.87076 19.4778 6.80626 19.6266 6.80626Z"
                  fill=""
                />
              </g>
            </svg>
